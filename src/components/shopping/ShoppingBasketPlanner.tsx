...
const baseBasket: BasketItem[] = [
  ...
  { name: "Jajka", amount: "10 szt.", price: 11, category: "Śniadania" },
  { name: "Kurczak", amount: "około 600 g", price: 19, category: "Obiady" },
  ...
  { name: "Jogurt naturalny", amount: "2 szt.", price: 6, category: "Nabiał" },
  {
